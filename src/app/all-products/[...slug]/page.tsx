...
import P1 from '@theme1/Pages/All-Products/[...slug]/page'
import P2 from '@theme2/Pages/All-Products/[...slug]/page'
import P3 from '@theme3/Pages/All-Products/[...slug]/page'
import P4 from '@theme4/Pages/All-Products/[...slug]/page'
import P5 from '@theme5/Pages/All-Products/[...slug]/page'
import P6 from '@theme6/Pages/All-Products/[...slug]/page'
import P8 from '@theme8/Pages/All-Products/[...slug]/page'
import P9 from '@theme9/Pages/All-Products/[...slug]/page'
import P11 from '@theme11/Pages/All-Products/[...slug]/page'
import P17 from '@theme17/Pages/All-Products/[...slug]/page'
...
export async function generateMetadata({
    ...
    if (isPaginated) {
        const withoutPage = slug.slice(0, -2);
        cleanSlug = withoutPage.length > 0 ? withoutPage[withoutPage.length - 1] : "";
    } else {
        cleanSlug = slug[slug.length - 1];
    }
    ...
    const metaSlug = ["product-page", cleanSlug].filter(Boolean);
    ...
    let baseUrl = `https://${companyDomain.domain}/all-products`;
    if (categorySlug) {
        baseUrl += `/${categorySlug}`;
    }
    // const baseUrl = `https://${companyDomain.domain}/all-products/${categorySlug}`;
