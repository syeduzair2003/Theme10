...
import P11 from '@/components/Theme-11/Pages/do-not-sell-my-personal-information/page';
import P17 from '@/components/Theme-17/Pages/do-not-sell-my-personal-information/page';
