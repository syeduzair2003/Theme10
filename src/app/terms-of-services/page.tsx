...
import P1 from '@theme1/Pages/Terms-Conditions/page';
import P2 from '@theme2/Pages/Terms-Conditions/page';
import P3 from '@theme3/Pages/Terms-Conditions/page';
import P4 from '@theme4/Pages/Terms-Conditions/Page';
...
import P11 from '@theme11/Pages/Terms-Conditions/page';
import P17 from '@theme17/Pages/Terms-Conditions/page';
import { Metadata } from 'next';
import { getBaseImageUrl } from '@/constants/hooks';
export async function generateMetadata(): Promise<Metadata> {
  const companyDomain = await cookieService.get("domain");
  const formattedData = JSON.stringify(["terms-of-services"]);
  const meta = (
  ...
  return {
    ...
    alternates: {
      canonical: `https://${companyDomain.domain}/terms-of-services`,
    },
    openGraph: {
