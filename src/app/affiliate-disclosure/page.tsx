...
import P1 from '@theme1/Pages/Affiliate-Disclosure/page';
import P2 from '@theme2/Pages/Affiliate-Disclosure/page';
import P3 from '@theme3/Pages/Affiliate-Disclosure/page';
import P4 from '@theme4/Pages/Affiliate-Disclosure/page';
import P5 from '@theme5/Pages/Affiliate-Disclosure/page';
import P6 from '@theme6/Pages/Affiliate-Disclosure/page';
import P8 from '@theme8/Pages/Affiliate-Disclosure/page';
import P9 from '@theme9/Pages/Affiliate-Disclosure/page';
import P11 from '@theme11/Pages/Affiliate-Disclosure/page';
import P17 from '@theme17/Pages/Affiliate-Disclosure/page';
import { Metadata } from 'next';
import { getBaseImageUrl } from '@/constants/hooks';
export async function generateMetadata(): Promise<Metadata> {
  const companyDomain = await cookieService.get("domain");
  const formattedData = JSON.stringify(["affiliate-disclosure"]);
  const meta = (
  ...
  return {
    ...
    alternates: {
      canonical: `https://${companyDomain.domain}/affiliate-disclosure`,
    },
    icons: [
