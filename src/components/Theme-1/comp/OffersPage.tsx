        ...
        <div>
            <section className="breadcrumb border-bottom p-0 d-block section-bg position-relative z-index-1">
                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-two-content text-center">
                                    ...
                                    <ul className="breadcrumb-list flx-align gap-2 mb-2 justify-content-center">
                                        ...
                                        <li className="breadcrumb-list__item font-14 text-body">
                                            <a href={`/all-stores/A`} className="breadcrumb-list__link text-body hover-text-main">Store</a>
                                        </li>
                                        <li className="breadcrumb-list__item font-14 text-body">
                                            <span className="breadcrumb-list__icon font-10"><i className="fas fa-chevron-right"></i></span>
                                        </li>
                                        <li className="breadcrumb-list__item font-14 text-body">
                                            <span className="breadcrumb-list__text">{merchant_details?.data?.merchant_name}</span>
                                        </li>
                                    </ul>

                                    <h1 className="breadcrumb-two-content__title mb-0 text-capitalize">{merchant_details?.data?.merchant_name}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {offers?.data?.offers.length > 0 && (
                    <p className="fw-bold font-14 text-center text-dark mb-0 py-2">
                ...
                <div className="container">
                    <div className="row flex-sm-column-reverse flex-xl-row flex-lg-row flex-md-row">
                        <div className="col-xs-12 col-lg-4 col-xl-4 col-md-4 d-xl-block d-lg-block d-md-block d-none">
                            ...
                            <div className="item-wrapper card border-0 shadow-sm rounded-4 p-3 p-md-4 text-center my-3">
                                {/* Logo Section */}
                            ...
                            {similarMerchant?.length > 0 && (
                                <div className="prod-item-wrapper p-4 p-md-2 rounded-4 bg-white shadow-sm my-3">
                                    ...
                                    <div className="similar-merchants-list d-grid gap-3 bg-light py-2 rounded-4">
                                        {similarMerchant?.slice(0, 5).map((merchant: Merchant, i: number) => (
