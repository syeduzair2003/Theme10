                ...
                <div className="mnav-inner">
                    ...
                    <nav>
                        <ul className="mnav-list list-unstyled ">
                            ...
                            {categories?.length > 0 && (
                                <li className="mnav-submenu">
                                    <div className="mnav-submenu-header">
                                        ...
                                        >
                                            <i
                                                className={`las ${openSection === "categories" ? "la-angle-up" : "la-angle-down"
                                                    }`}
                                            />
                                        </button>
                                    </div>
                            ...
                            {merchantData?.length > 0 && (
                                <li className="mnav-submenu">
                                    <div className="mnav-submenu-header">
                                        ...
                                        >
                                            <i
                                                className={`las ${openSection === "stores" ? "la-angle-up" : "la-angle-down"
                                                    }`}
                                            />
                                        </button>
                                    </div>
                            ...
                            {events?.length > 0 && (
                                <li className="mnav-submenu">
                                    <div className="mnav-submenu-header">
                                        ...
                                        >
                                            <i
                                                className={`las ${openSection === "events" ? "la-angle-up" : "la-angle-down"
                                                    }`}
                                            />
                                        </button>
                                    </div>
                            ...
                            {promotions?.length > 0 && (
                                <li className="mnav-submenu">
                                    <div className="mnav-submenu-header">
                                        ...
                                        >
                                            <i
                                                className={`las ${openSection === "Promotions" ? "la-angle-up" : "la-angle-down"
                                                    }`}
                                            />
                                        </button>
                                    </div>
                                    ...
                                    >
                                        {promotions?.map((promo: any, i: number) => (
                                            <li key={i}>
                                                <Link href={pathBuilder.promotion(promo)} onClick={toggle}>
                                                    {promo.name}
                                                </Link>
                                            </li>
                                        ))}
                            ...
                            <li>
                                <Link href="/all-products" onClick={toggle}>
                                    Products
                                </Link>
                            </li>
