...
const NewBrowseDeal = async ({ item, merchant_logo, merchant_name, merchantHref, productDetailUrl }: Props) => {
    ...
    // const discount = 
    return (
        <div className="browse-deal-card card p-3 ">
