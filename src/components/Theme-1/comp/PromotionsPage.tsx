...
import { getEventsHref, getPromotionHref } from '@/constants/hooks';
                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-two-content text-center">
                                    ...
                                    <ul className="breadcrumb-list flx-align gap-2 mb-2 justify-content-center">
                                        ...
                                        <li className="breadcrumb-list__item font-14 text-body">
                                            <span className="breadcrumb-list__text">Promotion</span>
                                        </li>
                                    </ul>

                                    <h1 className="breadcrumb-two-content__title mb-0 text-capitalize">Our Trending Promotions</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="events-section__wrapper">
                                <div className="row g-4">
                                    {promotions.map((promotion: any) => (
                                        <div className="col-lg-3 col-md-4 col-sm-6" key={promotion.id}>
