                            ...
                            {most_search?.length > 0 && (
                                <div className="my-3 mt-2 ts-container">
                                    <div className="suggested-events-section">
                                        <h4 className="ts-header">Most Searched Keywords</h4>
                                        <ul className="tags-wrapper">
                                            {most_search?.map((most_search: any, i: any) => (
                                                <li key={i}>
                                                    <Link
                                                        href={`/search?query=${most_search}`}
                                                        className="cat-sug"
                                                    >
                                                        {most_search}
                                                    </Link>
                            ...
                            {all_tags?.length > 0 && (
                                <div className="my-3 mt-2 ts-container">
                                    <div className="suggested-events-section">
                                        <h4 className="ts-header">Most Searched Keywords</h4>
                                        <ul className="tags-wrapper">
                                            {all_tags?.map((all_tags: any, i: any) => (
                                                <li key={i}>
                                                    <Link
                                                        href={`/search?query=${all_tags}`}
                                                        className="cat-sug"
                                                    >
                                                        {all_tags}
                                                    </Link>
                        ...
                        <div className="col-lg-9 pb-2 merchant-main-page box-border">
                            ...
                            {searchResult?.categories?.length > 0 && (
                                <>
                                    ...
                                    <div className="row g-3"> {/* g-3 adds consistent gap */}
