...
const BannerSlider = ({ domain, companyId, slug_type, mer_slug }: Props) => {
    ...
    // :large_green_circle: AUTOPLAY LOGIC
    useEffect(() => {
    ...
    return (
        <section ref={sliderSectionRef} className="container-fluid custom-width" style={{backgroundColor:"#e0f2f1"}}>
            {offers?.length > 0 ? (
