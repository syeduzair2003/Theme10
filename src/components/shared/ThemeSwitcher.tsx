...
import theme11Layout from '../Theme-11/theme11Layout';
import theme17Layout from '../Theme-17/theme17Layout';
...
const ThemeSwitcher = async ({ children, template }: Props) => {
    ...
    const SelectedLayout = selector('theme 17');
    return (
        <SelectedLayout>
            {children}
        </SelectedLayout>
