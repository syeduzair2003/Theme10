...
const BodyBottomScriptsComponent = ({ scripts }: Props) => {
...
const BodyBottomScripts = React.memo(BodyBottomScriptsComponent);
BodyBottomScripts.displayName = 'BodyBottomScripts';

export default BodyBottomScripts;
