    ...
    <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
      ...
      <aside className="w-full lg:w-1/3 xl:w-1/4 order-2 lg:order-2 space-y-8 md:space-y-10">
        ...
        {bannerResponse?.offers?.length > 0 && initialFiltered.length > 0 && (
          <div className="bg-[#1A1A1A] rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 shadow-2xl text-white overflow-hidden relative">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#800000]/40 blur-3xl rounded-full -mr-16 -mt-16"></div>
            <h4 className="text-lg md:text-xl font-black mb-6 md:mb-8 flex items-center gap-3 relative z-10 tracking-tight">
