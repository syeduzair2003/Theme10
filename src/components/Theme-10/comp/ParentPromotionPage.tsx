    ...
    <div className="bg-[#f8fafc] min-h-screen pb-20">
      ...
      <div className="container mx-auto px-6 space-y-24">
        ...
        {subPromotions?.length > 0 && (
          <section>
            <div className="flex flex-col mb-12">
              <span className="text-blue-600 font-black text-[11px] uppercase tracking-[0.3em] mb-2">
                Curated Collections
              </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {subPromotions.map((item: SubPromotion, index: number) => (
                <Link
                  ...
                  className="group relative h-[300px] overflow-hidden rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all duration-700"
                >
                  <Image
                    src={getBaseImageUrl(
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/20 to-transparent p-10 flex flex-col justify-end">
                    <h3 className="text-white text-3xl font-black tracking-tight mb-2 group-hover:-translate-y-2 transition-transform duration-500">
                      {item.category_name}
                    </h3>
        ...
        <section className="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-sm relative overflow-hidden">
          ...
          <h2 className="text-2xl font-black text-slate-900 text-center mb-16 uppercase tracking-[0.2em]">
            Featured Brands
          </h2>
