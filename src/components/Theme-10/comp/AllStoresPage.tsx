                ...
                >
                  <ol className="flex items-center space-x-3 text-sm font-medium">
                    <li>
                      <Link
                        href="/"
                        className="no-underline uppercase text-slate-500 hover:text-blue-600 transition-colors"
                      >
                        Home
                      </Link>
                    </li>
                    ...
                    <li className="flex items-center space-x-3">
                      <FontAwesomeIcon
                        ...
                        className="w-2.5 h-2.5 text-slate-400"
                      />
                      <span className="text-blue-600 capitalize bg-blue-50 px-3 py-1 rounded-full font-bold">
                        {slug}
                      </span>
                    </li>
                  </ol>
          ...
          <Reveal>
            <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-slate-300">
              ...
              <h3 className="text-xl font-bold text-slate-800">
                No merchants found for &quot;{slug}&quot;
              </h3>
              <p className="text-slate-500">
                Try selecting a different alphabet.
              </p>
            </div>
          </Reveal>
        )}
