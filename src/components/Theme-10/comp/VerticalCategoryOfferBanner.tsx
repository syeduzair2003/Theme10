...
const VerticalCategoryOfferBanner = ({
  ...
  return (
    <div
      className="side-bar sidebar-review-box text-center"
    ...
    >
      ...
      <div
        className={`d-flex align-items-center ${isExpanded ? "justify-content-between" : "justify-content-center"}`}
      >
        {hasMore && (
          <button
            onClick={loadMore}
            className="box-style box-second gap-2 gap-md-3 rounded-pill py-2 py-md-3 px-5 px-md-7 d-center d-inline-flex"
          >
        ...
        {isExpanded && (
          <button
            onClick={showLess}
            className="box-style box-second gap-2 gap-md-3 second-alt rounded-pill py-2 py-md-3 px-5 px-md-7 d-center d-inline-flex"
          >
