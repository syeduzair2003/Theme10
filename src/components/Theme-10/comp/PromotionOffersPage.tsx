...
const PromotionOffersPage = async ({ params }: { params: string }) => {
  ...
  <div className="container mx-auto px-6">
    ...
    {/* --- REDESIGNED PREMIUM HERO SECTION (Centered with Exact Bottom Border) --- */}
    <div className="relative bg-[#FDFBE7] rounded-[3.5rem] pt-12 pb-20 px-10 md:px-16 
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <nav className="mb-10 w-full border-b border-[#EADDCA]/60 pb-6">
          <ol className="flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">
            ...
            <li>
              <Link href={`/${companyData?.promotion_slug}`} className="no-underline hover:text-[#800000] transition-colors">Promotions</Link>
            </li>
          </ol>
        </nav>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-6 mt-8 border-t border-[#EADDCA]/60">
            ...
            <div className="inline-flex items-center gap-2 bg-white px-3.5 py-1.5 rounded-full border border-[#800000]/10 shadow-sm">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-[#800000]">Active Campaign</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-[#1A1A1A]/70 text-[11px] font-bold uppercase tracking-[0.2em] bg-[#EADDCA]/30 px-4 py-1.5 rounded-full">
               <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                 <path d="M6 10.5a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                 <path d="M6 3v3h2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
               </svg>
    ...
    {/* --- EVENT BANNER SECTION (Below the Card) --- */}
    {banners?.length > 0 && (
  ...
  {/* xl:flex-row-reverse switches Sidebar to Left and Content to Right */}
  <div className="flex flex-col xl:flex-row-reverse gap-12">
    
    {/* --- NOW ON THE RIGHT: Offers Content --- */}
                ...
                <div className="col-span-full py-12 px-10 bg-[#FDFBE7] rounded-[3.5rem] border border-[#EADDCA]">
                  <div className="flex items-center justify-between mb-10">
                    <h4 className="text-slate-900 font-black text-xl uppercase tracking-tighter">
                      Premium <span className="text-[#800000]">Partners</span>
                    </h4>
                    <FontAwesomeIcon
                      icon={faFire}
