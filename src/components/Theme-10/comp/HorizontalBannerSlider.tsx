  ...
  {offers.length > 0 ? (
    <div className="max-w-[1400px] mx-auto px-4 md:px-6">
      <div className="relative overflow-hidden rounded-[2rem] shadow-[0_20px_50px_-20px_rgba(128,0,0,0.15)] border border-[#800000]/5">
        ...
        >
          <FontAwesomeIcon icon={faAngleLeft} className="text-[#1A1A1A] group-hover/btn:text-[#FDFCF0] transition-colors" />
        </button>
        ...
        >
          <FontAwesomeIcon icon={faAngleRight} className="text-[#1A1A1A] group-hover/btn:text-[#FDFCF0] transition-colors" />
        </button>

        {/* Bottom Decorative Indicator (Optional Aesthetic) */}
