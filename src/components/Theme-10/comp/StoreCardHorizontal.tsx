...
const StoreCardHorizontal = async ({
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 p-4 rounded-[2.5rem] bg-white/5 backdrop-blur-md hover:bg-white/10 transition-all border border-white/10 hover:border-[#800000]/40 group shadow-none hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] min-w-[290px] w-full h-full flex-shrink-0 relative overflow-hidden">
        {/* Logo Box */}
