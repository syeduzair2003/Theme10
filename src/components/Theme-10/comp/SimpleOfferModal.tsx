...
const SimpleOfferModal = ({
  ...
  return ReactDOM.createPortal(
    <div className="offer-modal-overlay-two" onClick={onClose}>
      <div
        className="offer-modal-container-two"
      ...
      >
        ...
        <div className="offer-modal-body-two">
          <div
            className={`modal-img-wrapper-two cus-border ${data?.product_image ? "horizontal-image-wrapper" : "merchant-img-wrapper-modal"} border b-eighth rounded-4  position-relative`}
          >
            {finalDiscountTag && (
        ...
        {/* Footer/Extension Popup Style Bar */}
