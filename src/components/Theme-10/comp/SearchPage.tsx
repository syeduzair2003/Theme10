    ...
    <div className="space-y-8">
      <div className="flex items-center gap-6">
        <h2 className="text-xl font-bold text-[#1A1A1A]">
          Stores matching <span className="text-[#800000] font-serif italic lowercase font-normal normal-case tracking-normal ml-1">"{query}"</span>
        </h2>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="text-[9px] font-black text-slate-400 group-hover:text-[#800000] flex items-center gap-2 tracking-[0.15em] transition-colors mt-1">
                EXPLORE STORE <FontAwesomeIcon icon={faArrowRight} className="w-2 h-2" />
              </span>
            </div>
          </Link>
        ))}
    ...
    <div className="space-y-8">
      <div className="flex items-center gap-6">
        <h2 className="text-xl font-black text-[#1A1A1A] tracking-[0.05em] uppercase shrink-0">
          Categories in <span className="text-[#800000] font-serif italic lowercase font-normal normal-case tracking-normal ml-1">"{query}"</span>
        </h2>
        <div className="h-px flex-1 bg-gradient-to-r from-[#800000]/20 to-transparent" />
      </div>
