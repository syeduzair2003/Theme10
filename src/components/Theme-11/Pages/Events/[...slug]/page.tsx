...
import EventsOfferCard, { EventsGrid } from '@/components/Theme-11/comp/EventsOfferCard';
import VerticalPromotionOfferBanner from '@/components/Theme-11/comp/VerticalPromotionOfferBanner';
