...
const page = async () => {
    ...
    const response = await ((await apiGetAllEvents(companyDomain?.domain))?.data)
    return (
        <>
                ...
                <div className='max-w-[1200px] mx-auto mt-10 px-6'>
                    {response.length ? (
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6'>
                            {response?.map((event: EventResponse, index: number) => (
                 ...
                 transition-all duration-300 ease-in-out"
                     ...
                     group-hover:text-[var(--primary-color)] transition-colors">
                                    ...
                                    <div className="flex justify-center items-center">
                                        ...
                                        <p className="text-sm font-semibold text-[var(--primary-color)] text-center opacity-80 
                    group-hover:opacity-100 transition-opacity">
                       ...
                       transition-all duration-300 group-hover:w-full rounded-b-2xl">
                        ...
                        Looks like there are no events right now — check back soon!
                    </p>
                    }
                </div>
            </section>
