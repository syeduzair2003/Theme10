...
import MerchantProductsPage from '@/components/Theme-5/comp/MerchantProductsPage'
import OfferDetailsPage from '@/components/Theme-5/comp/OfferDetailsPage';
import { notFound, redirect } from 'next/navigation';
import { extractTrailingId } from '@/constants/hooks';
import { apiGetMerchantUniqueId } from '@/apis/merchant';
import CategoryProductOffers from '@/components/Theme-5/comp/CategoryProductoffers';
