...
import CategoryProductOffers from '@/components/Theme-2/comp/CategoryProductOffers';
import MerchantProductsPage from '@/components/Theme-2/comp/MerchantProductsPage';
import OfferDetailsPage from '@/components/Theme-2/comp/OfferDetailsPage';
