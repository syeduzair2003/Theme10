...
import {
  faFacebook, faTwitter, faPinterest, faYoutube,
  faLinkedin, faInstagram, faTiktok, faFlipboard,
  faWhatsapp, faTelegram, faXTwitter
} from '@fortawesome/free-brands-svg-icons';

import {
  faAt, faArrowRight, faAngleRight, faAngleLeft,
  faUser, faBriefcase, faWallet, faGreaterThan,
  faHeart, faPaperPlane, faCalendarDays, faArrowUp,
  faThumbsUp, faThumbsDown, faSearch, faUserGear,
